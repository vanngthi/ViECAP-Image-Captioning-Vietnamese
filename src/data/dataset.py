...
class CaptionsDataset(Dataset):
    ...
    def __init__(
        self,
        language_model: str = 'NlpHUST/gpt2-vietnamese',
        max_num_of_entities: int = 5,
        using_clip_features: bool = False,
        path_of_datasets: str = './annotations/uit_viic_entities_with_features.pkl',
        debug: bool = False,
        args = None,
    ) -> None:
        """
        ...
        self.objects_vocabs = load_entities_text(args.name_of_objects_vocabs, args.path_of_objects_vocabs, all_entities = True)
    ...
    def __getitem__(self, item: int) -> Tuple[torch.Tensor, ...]:
        ...
        if self.args.using_hard_prompt:
            discrete_tokens = parse_entities(self.args, self.tokenizer, [detected_entities], self.stopwords, self.objects_vocabs)[0]
